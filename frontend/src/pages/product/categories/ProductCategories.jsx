...
import {
  getAllArtsSubdomains,
  getAllCommerceSubdomains,
  getAllEngineeringSubdomains,
...
const ProductCategories = () => {
  ...
  renderEngineeringSubjects =
    engineeringSubjects.total_count >= 0 ? (
  ...
  renderCommerceSubjects =
    commerceSubjects.total_count >= 0 ? (
